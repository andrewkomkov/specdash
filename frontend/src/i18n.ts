...
const EN = {
  ...
  'checks.findings': 'What the artefacts disagree about',
  'checks.none': 'Nothing disagrees. Every check this feature can be given, it passes.',
  'checks.andMore': '…and {count} more',
  'checks.severity.blocker': 'blocker',
  'checks.severity.warn': 'warn',
  'checks.severity.info': 'info',
  ...
  'checks.verdict.pass': 'pass',
  'checks.verdict.fail': 'fail',
  'checks.verdict.unknown': 'unknown',
  'checks.complexity': 'Declared complexity',
  ...
  'project.drift': '{count} installed file(s) modified or missing',
  'project.workflows': '{count} declared workflow(s)',
  ...
  'search.foundBy': '{total} found {how} · {ms} ms',
...
const RU: Partial<Record<Key, string>> = {
  ...
  'checks.none': 'Расхождений нет. Все проверки, применимые к этой фиче, пройдены.',
  'checks.andMore': '…и ещё {count}',
  'checks.severity.blocker': 'блокер',
  'checks.severity.warn': 'предупреждение',
  'checks.severity.info': 'к сведению',
  'checks.constitution': 'Проверка конституции (plan.md)',
  'checks.noSection': 'В plan.md нет секции о конституции.',
  'checks.noEvidence': 'Секция не выносит вердикта, поэтому он и не додумывается.',
  'checks.verdict.pass': 'пройдена',
  'checks.verdict.fail': 'провалена',
  'checks.verdict.unknown': 'неизвестно',
  'checks.complexity': 'Заявленные исключения',
  'checks.complexityHint':
    'Исключения, которые план обосновал письменно, — это записанное решение, а не недосмотр.',
  'checks.violation': 'Нарушение',
  'checks.whyNeeded': 'Зачем понадобилось',
  'checks.alternative': 'Почему отвергнут более простой вариант',

  'project.toolchain': 'spec-kit {version}',
  'project.drift': 'Изменённых или отсутствующих установленных файлов: {count}',
  'project.workflows': 'Объявленных воркфлоу: {count}',
  ...
  'search.placeholder': 'Поиск по спекам, планам, задачам, требованиям…',
  'search.nothing': 'Ничего не нашлось по запросу {query}.',
  'search.didYouMean': 'Возможно, вы имели в виду',
  'search.navigate': 'перемещаться',
  'search.open': 'открыть',
  'search.close': 'закрыть',
  'search.foundBy': 'найдено {total} {how} · {ms} мс',
  ...
  'search.kind.requirement': 'треб.',
  'search.kind.checklist': 'чеклист',
